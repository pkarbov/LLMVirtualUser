...
export default {
    ...
    computed: {
	    loadedRooms() {
	        console.log('ChatContainer::loadedRooms()')

	        return this.rooms.slice(0, this.roomsLoadedCount)
	    },
	    screenHeight() {
	        console.log('ChatContainer::screenHeight()')
    ...
    methods: {
	        async addCss() {
            console.log('ChatContainer::addCss()')
	        ...
	        resetRooms() {
              console.log('ChatContainer::resetRooms()')
	        ...
	        resetMessages() {
              console.log('ChatContainer::resetMessages()')
	        ...
	        fetchRooms() {
              console.log('ChatContainer::fetchRooms()')
	    ...
	    async fetchMoreRooms() {
          console.log('ChatContainer::fetchMoreRooms()')
	    ...
	    formatLastMessage(message, room) {
          console.log('ChatContainer::formatLastMessage()', message, room)
	    ...
	    fetchMessages({ room, options = {} }) {
          console.log('ChatContainer::fetchMessages()', room, options)
	    ...
	    listenMessages(room) {
          console.log('ChatContainer::listenMessages()', room)
	    ...
	    markMessagesSeen(room, message) {
          console.log('ChatContainer::markMessagesSeen()', room, message)
	    ...
	    formatMessage(room, message) {
          console.log('ChatContainer::formatMessage()', room, message)
	    ...
	    async sendMessage({ content, roomId, files, replyMessage }) {
          console.log('ChatContainer::sendMessage()', content, roomId, files, replyMessage)
	    ...
	    async editMessage({ messageId, newContent, roomId, files }) {
          console.log('ChatContainer::editMessage()', messageId, newContent, roomId, files)
	    ...
	    async deleteMessage({ message, roomId }) {
          console.log('ChatContainer::deleteMessage()', message, roomId)
	    ...
	    async uploadFile({ file, messageId, roomId }) {
          console.log('ChatContainer::uploadFile()', file, messageId, roomId)
	    ...
	    updateFileProgress(messageId, fileUrl, progress) {
          console.log('ChatContainer::updateFileProgress()', messageId, fileUrl, progress)
	    ...
	    formattedFiles(files) {
          console.log('ChatContainer::formattedFiles()', files)
	    ...
	    openFile({ file }) {
          console.log('ChatContainer::openFile()', file)

	        window.open(file.file.url, '_blank')
	    },

	    async openUserTag({ user }) {
          console.log('ChatContainer::openUserTag()', user)
	    ...
	    async loadRoom(query) {
          console.log('ChatContainer::loadRoom()', query)
	    ...
	    menuActionHandler({ action, roomId }) {
          console.log('ChatContainer::menuActionHandler()', action, roomId)
	    ...
	    messageSelectionActionHandler({ action, messages, roomId }) {
          console.log('ChatContainer::messageSelectionActionHandler()', action, messages, roomId)
	    ...
	    async sendMessageReaction({ reaction, remove, messageId, roomId }) {
          console.log('ChatContainer::sendMessageReaction()', reaction, remove, messageId, roomId)
	    ...
	    typingMessage({ message, roomId }) {
          console.log('ChatContainer::typingMessage()', message, roomId)
	    ...
	    async listenRooms(query) {
          console.log('ChatContainer::listenRooms()', query)
	    ...
	    listenUsersOnlineStatus(rooms) {
          console.log('ChatContainer::listenUsersOnlineStatus()', rooms)
	    ...
	    addRoom() {
          console.log('ChatContainer::addRoom()')
	    ...
	    async createRoom() {
          console.log('ChatContainer::createRoom()')
	    ...
	    inviteUser(roomId) {
          console.log('ChatContainer::inviteUser()', roomId)
	    ...
	    async addRoomUser() {
          console.log('ChatContainer::addRoomUser()')
	    ...
	    removeUser(roomId) {
          console.log('ChatContainer::removeUser()', roomId)
	    ...
	    async deleteRoomUser() {
          console.log('ChatContainer::deleteRoomUser()')
	    ...
	    async deleteRoom(roomId) {
          console.log('ChatContainer::deleteRoom()', roomId)
	    ...
	    resetForms() {
          console.log('ChatContainer::resetForms()')
